...
async def hg(bot: Client, msg: Message):
    for new_user in msg.new_chat_members:
        if str(new_user.id) == str(Config.OWNER_ID):
            ...
            buttons = [[InlineKeyboardButton("➕ Qrupa Əlavə Et ➕",url="http://t.me/CrazyTagBot?startgroup=a"),
                    InlineKeyboardButton("👨🏻‍💻 Bot Sahibi", url="https://t.me/Dakanca_Hozu"),
                    InlineKeyboardButton("✅ Rəsmi Kanal", url="https://t.me/Crazy_Resmi")]]
